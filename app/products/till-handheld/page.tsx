...
import { Smartphone, CreditCard, WifiOff, ScanBarcode, ChefHat, Printer, ArrowRight, Check, ChevronDown } from 'lucide-react'

if (typeof window !== 'undefined') {
  gsap.registerPlugin(ScrollTrigger)
}

export default function TillHandheldPage() {
  ...
  const features = [
    {
      ...
      description: 'Switch between Cashier POS and Self-Ordering Kiosk on the same Feitian terminal.'
    },
    {
      icon: CreditCard,
      title: 'Native Payment Integration',
      description: 'SmartPay + Feitian ECR SDK for card, cash, and split payments directly on terminal.'
    },
    {
      icon: WifiOff,
      title: 'Offline-First Architecture',
      description: 'Full order taking works without internet, auto-syncs when reconnected.'
    },
    {
      icon: ScanBarcode,
      title: 'Barcode Scanning',
      description: 'Built-in camera scanning (ML Kit) + USB scanner support for retail and inventory.'
    },
    {
      icon: ChefHat,
      title: 'Kitchen Integration',
      description: 'Orders fire directly to KDS with station routing, priority, and coursing support.'
    },
    {
      icon: Printer,
      title: 'Multi-Printer Support',
      description: 'Bluetooth, USB, Network, and built-in thermal printing for receipts and kitchen slips.'
    }
  ]

  const benefits = [
    'Runs natively on Feitian RFM Loyalty Android payment devices',
    'No separate POS hardware needed — payment terminal IS your POS',
    'Staff PIN login with role-based access control',
    'Shift management with cash reconciliation and Z-reports',
    'Combo meals with configurable groups and selections',
  ...
  const faqs = [
    {
      question: 'What devices does Till Handheld run on?',
      answer: 'Feitian RFM Loyalty Android payment terminals. No separate POS hardware needed.'
    },
    {
      question: 'Does it work offline?',
      answer: 'Yes, full order taking works without internet. Data syncs automatically when reconnected.'
    },
    {
      question: 'Can it switch between staff POS and customer kiosk?',
      answer: 'Yes, dual-mode operation lets you toggle between cashier mode and self-ordering kiosk mode.'
    },
    {
      question: 'What payment methods are supported?',
      answer: 'Cash, card (via SmartPay/Feitian ECR), split payments, and tips.'
    },
    {
      question: 'What printers are compatible?',
      answer: 'Built-in thermal, Bluetooth ESC/POS, USB, and network printers.'
    }
  ]
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="hero-content">
              ...
              <h1 className="font-palmore text-[clamp(3.5rem,10vw,8rem)] text-white uppercase leading-[0.85] mb-8">
                TILL<br />
                <span className="text-coral">HANDHELD</span>
              </h1>

              <p className="text-xl md:text-2xl text-white/70 max-w-xl font-light leading-relaxed mb-12">
                A complete CloudPOS that runs natively on Feitian RFM Loyalty Android payment terminals. Dual-mode operation — staff POS and customer self-ordering on the same device.
              </p>
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="fade-in-section text-center mb-20">
            <h2 className="font-palmore text-6xl md:text-7xl text-navy uppercase mb-6 leading-none">
              YOUR POS,<br />YOUR <span className="text-coral">TERMINAL</span>
            </h2>
            <p className="text-xl text-navy/70 max-w-3xl mx-auto leading-relaxed">
              Everything you need to run your restaurant — order taking, payments, kitchen routing, and printing — all from a single handheld device.
            </p>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="fade-in-section text-center mb-16">
            <h2 className="font-palmore text-6xl md:text-7xl text-white uppercase mb-6 leading-none">
              ONE DEVICE,<br />
              <span className="text-golden">ZERO LIMITS</span>
            </h2>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto text-center fade-in-section">
          <div className="bg-gradient-to-br from-coral to-golden rounded-3xl p-16 shadow-2xl">
            <h2 className="font-palmore text-5xl md:text-6xl text-white uppercase mb-6 leading-none">
              READY TO GO<br />HANDHELD?
            </h2>
            <p className="text-xl text-white/90 mb-12 max-w-2xl mx-auto">
              Transform your Feitian terminal into a complete CloudPOS. Setup takes minutes, not days.
            </p>
