...
import { Monitor, ListOrdered, Timer, AlertTriangle, Ban, Layers, ArrowRight, Check, ChevronDown } from 'lucide-react'
...
export default function KitchenDisplayPage() {
  ...
  const features = [
    {
      icon: Monitor,
      title: 'Station-Based Routing',
      description: 'Route items to specific kitchen stations automatically based on category.'
    },
    {
      icon: ListOrdered,
      title: 'Real-Time Queue',
      description: 'Live order flow: Pending, Cooking, Ready, Served with tap-to-update.'
    },
    {
      icon: Timer,
      title: 'Cook Time Analytics',
      description: 'Track average preparation time per item and per station for optimization.'
    },
    {
      icon: AlertTriangle,
      title: 'Expedite & Priority',
      description: 'Flag rush orders for priority handling across all stations.'
    },
    {
      icon: Ban,
      title: 'Smart 86/Hold',
      description: 'Mark ingredients unavailable and auto-hold all dependent menu items.'
    },
    {
      icon: Layers,
      title: 'Multi-Course Support',
      description: 'Auto-fire courses in sequence for fine dining service flow.'
    }
  ]

  const benefits = [
    'Zero missed orders — every ticket appears on screen instantly',
    'Track kitchen staff performance with preparation metrics',
    'Reduce food waste with ingredient-level availability (Smart 86)',
    'Kitchen slip printing with custom formatting per station',
    'Real-time sync across all terminals and dashboard',
    'Works on any Android tablet or mounted display'
  ]

  const stats = [
    { value: '40%', label: 'Faster Prep' },
  ...
  const faqs = [
    {
      question: 'What is the Kitchen Display System?',
      answer: 'A digital screen replacing paper tickets, showing real-time orders with status tracking and station routing.'
    },
    {
      question: 'Can I set up multiple stations?',
      answer: 'Yes, route items to different stations (grill, fryer, bar, etc.) automatically by category.'
    },
    {
      question: 'Does it track cook times?',
      answer: 'Yes, average preparation time per item and per station is tracked for performance optimization.'
    },
    {
      question: 'What is Smart 86?',
      answer: 'When an ingredient runs out, Smart 86 automatically holds all menu items that use that ingredient.'
    },
    {
      question: 'Can it handle multi-course meals?',
      answer: 'Yes, coursing support auto-fires courses in sequence for fine dining.'
    }
  ]
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="hero-content">
              ...
              <h1 className="font-palmore text-[clamp(3.5rem,10vw,8rem)] text-white uppercase leading-[0.85] mb-8">
                KITCHEN<br />
                <span className="text-coral">DISPLAY</span>
              </h1>

              <p className="text-xl md:text-2xl text-white/70 max-w-xl font-light leading-relaxed mb-12">
                Eliminate paper tickets. Real-time station-based order routing with cook time tracking, priority management, and coursing support.
              </p>
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="fade-in-section text-center mb-20">
            <h2 className="font-palmore text-6xl md:text-7xl text-navy uppercase mb-6 leading-none">
              DITCH THE PAPER,<br /><span className="text-coral">GO DIGITAL</span>
            </h2>
            <p className="text-xl text-navy/70 max-w-3xl mx-auto leading-relaxed">
              Every order flows through a live digital queue. Station routing, priority management, and cook time tracking keep your kitchen running at peak efficiency.
            </p>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto text-center fade-in-section">
          <div className="bg-gradient-to-br from-coral to-golden rounded-3xl p-16 shadow-2xl">
            <h2 className="font-palmore text-5xl md:text-6xl text-white uppercase mb-6 leading-none">
              READY TO UPGRADE<br />YOUR KITCHEN?
            </h2>
            <p className="text-xl text-white/90 mb-12 max-w-2xl mx-auto">
              Eliminate paper tickets and missed orders. Get your kitchen running on real-time digital displays.
            </p>
